        ...
        <div className="">
          <div className="main relative w-full  lg:min-h-[933px] h-full ">
            ...
            <div className="main flex h-full w-full relative ">
              ...
              <p className="text-sm text-center px-2 sm:text-lg font-inter text-Grey absolute top-[513px] left-1/2 -translate-x-1/2 max-w-[800px] w-full text-center z-20 ">
              ...
              <div className="button  flex justify-center w-full absolute top-[580px] sm:top-[560px] left-1/2 -translate-x-1/2 z-20">
                <div className="button    relative  flex justify-between items-center w-[288px] sm:w-[320px] h-full rounded-full ">
                  <button className=" left-0 bg-Primary w-[228px] sm:w-[268px] h-[52px]  rounded-full text-lg text-white font-Dmsans  shadow-[0px_26px_26px_rgba(53,121,246,0.62)] ">
                    Create Account Now
                  </button>
